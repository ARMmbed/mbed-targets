...
```bash
python ci_scripts/generate_docs.py
```

This will generate the docs and output them to `docs/user_docs/local_output/`.
...
Documentation only gets committed back to this repo to the `docs/user_docs/output`
